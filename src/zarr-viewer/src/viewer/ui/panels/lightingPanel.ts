...
export function lightingPanelBody(params: { rendering: WebGpuRenderingState }): string {
  ...
  return [
    ...
    `<label class="whud__check"><input type="checkbox" data-chk="fullQualityNav" ${r.fullQualityNav ? "checked" : ""}/> Full quality while navigating (no step-size coarsening)</label>`,
