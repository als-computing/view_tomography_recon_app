/**
 * One-shot packer for `VolumeRenderer`'s per-frame uniform buffer (`frameData`, 128 floats at fixed
...
/**
 * Pack one frame's worth of uniforms into `d` (128 floats, fixed offsets — see inline comments for
